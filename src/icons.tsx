...
export type NavGlyphName = 'overview' | 'sessions' | 'generatedAssets' | 'workspace' | 'worktrees' | 'plugins' | 'settings'
...
const NavGlyph: Record<NavGlyphName, string> = {
  ...
  // A branch: one trunk, two checkouts off it — a worktree in one stroke.
  worktrees: 'M7 5.6v12.8 M7 9.6h4.6a2.4 2.4 0 0 1 2.4 2.4v0a2.4 2.4 0 0 0 2.4 2.4H17 M7 5.6a1.6 1.6 0 1 0 0 .01Z M17 12.8a1.6 1.6 0 1 0 0 .01Z M7 18.4a1.6 1.6 0 1 0 0 .01Z',

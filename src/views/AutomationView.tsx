...
export default function AutomationView() {
  ...
  return <>
    <section className="page-heading"><div><h2>自动清理</h2></div><span className={`pill ${state.loaded ? 'status-current' : ''}`}>{settings.enabled ? state.loaded ? '已安装' : '未加载' : '已关闭'}</span></section>
